...
- [x] Vercel 배포 · 공개 오픈 — 2026-08-08 https://utube-trend-tracer.vercel.app
      Root Directory `web`, anon key만 등록(service key 없음), GitHub 연동으로 push 시 자동 배포.
      검증: 4개 보드·정책 페이지 렌더, 보안 헤더(CSP·Referrer·X-Frame) 적용, 배포본에 키 미노출 확인
